...
public final class ErrorHandlingUtils {
	 ...
	 * @since 2.9.7
	 * @deprecated in favor of {@link #retryBatch(Exception, ConsumerRecords, Consumer, MessageListenerContainer,
	 * Runnable, BackOffExecution, CommonErrorHandler, BiConsumer, LogAccessor, KafkaException.Level, List,
	 * ExceptionMatcher, boolean, boolean)}.
	 */
	@Deprecated
