...
public class RecoveringDeserializationExceptionHandler
	 ...
	 */
	public static final String KSTREAM_DESERIALIZATION_NATIVE_DLQ_DESTINATION_RESOLVER = "spring.deserialization.native.dlq.destination.resolver";
	...
	public void configure(Map<String, ?> configs) {
		configureCommon(configs, KSTREAM_DESERIALIZATION_NATIVE_DLQ_DESTINATION_RESOLVER, KSTREAM_DESERIALIZATION_RECOVERER);
	}
