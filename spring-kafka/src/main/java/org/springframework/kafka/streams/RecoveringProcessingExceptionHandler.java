...
public class RecoveringProcessingExceptionHandler
	 ...
	 */
	public static final String KSTREAM_PROCESSING_RECOVERER = "spring.processing.recoverer";

	/**
	 * Property name for configuring the native DLQ destination resolver.
	 */
	public static final String KSTREAM_PROCESSING_NATIVE_DLQ_DESTINATION_RESOLVER = "spring.processing.native.dlq.destination.resolver";
	...
	public void configure(Map<String, ?> configs) {
		configureCommon(configs, KSTREAM_PROCESSING_NATIVE_DLQ_DESTINATION_RESOLVER, KSTREAM_PROCESSING_RECOVERER);
	}
