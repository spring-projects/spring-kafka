...
public class RecoveringProductionExceptionHandler
	 ...
	 */
	public static final String KSTREAM_PRODUCTION_RECOVERER = "spring.production.recoverer";

	/**
	 * Property name for configuring the native DLQ destination resolver.
	 */
	public static final String KSTREAM_PRODUCTION_NATIVE_DLQ_DESTINATION_RESOLVER = "spring.production.native.dlq.destination.resolver";
	...
	public void configure(Map<String, ?> configs) {
		configureCommon(configs, KSTREAM_PRODUCTION_NATIVE_DLQ_DESTINATION_RESOLVER, KSTREAM_PRODUCTION_RECOVERER);
	}
