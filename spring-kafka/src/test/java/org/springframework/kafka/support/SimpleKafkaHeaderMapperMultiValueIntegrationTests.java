...
import org.springframework.kafka.support.SimpleKafkaHeaderMapperMultiValueIntegrationTests.Config.MultiValueTestListener;
import org.springframework.kafka.support.SimpleKafkaHeaderMapperMultiValueIntegrationTests.RetryTopicConfigurations.FirstTopicListener;
import org.springframework.kafka.support.SimpleKafkaHeaderMapperMultiValueIntegrationTests.RetryTopicConfigurations.MyCustomDltProcessor;
...
@EmbeddedKafka(partitions = 1, topics = {
		SimpleKafkaHeaderMapperMultiValueIntegrationTests.TEST_TOPIC,
		SimpleKafkaHeaderMapperMultiValueIntegrationTests.RETRY_TOPIC
})
class SimpleKafkaHeaderMapperMultiValueIntegrationTests {
	...
	public static class Config {
		...
		public KafkaListenerContainerFactory<?> kafkaListenerContainerFactory() {
			...
			headerMapper.addHeaderPatternsForMultiValue(MULTI_VALUE_HEADER1, MULTI_VALUE_HEADER2);
