...
import org.springframework.kafka.support.DefaultKafkaHeaderMapperForMultiValueTests.Config.MultiValueTestListener;
import org.springframework.kafka.support.DefaultKafkaHeaderMapperForMultiValueTests.RetryTopicConfigurations.FirstTopicListener;
import org.springframework.kafka.support.DefaultKafkaHeaderMapperForMultiValueTests.RetryTopicConfigurations.MyCustomDltProcessor;
...
@EmbeddedKafka(partitions = 1, topics = {
		DefaultKafkaHeaderMapperForMultiValueTests.TEST_TOPIC,
		DefaultKafkaHeaderMapperForMultiValueTests.RETRY_TOPIC
})
class DefaultKafkaHeaderMapperForMultiValueTests {
