...
class RecoveringProductionExceptionHandlerTests
	...
	RecoveringProductionExceptionHandlerTests() {
		super(RecoveringProductionExceptionHandler.KSTREAM_PRODUCTION_RECOVERER,
				RecoveringProductionExceptionHandler.KSTREAM_PRODUCTION_NATIVE_DLQ_DESTINATION_RESOLVER);
	}
