...
class RecoveringProcessingExceptionHandlerTests
	...
	RecoveringProcessingExceptionHandlerTests() {
		super(RecoveringProcessingExceptionHandler.KSTREAM_PROCESSING_RECOVERER,
				RecoveringProcessingExceptionHandler.KSTREAM_PROCESSING_NATIVE_DLQ_DESTINATION_RESOLVER);
	}
