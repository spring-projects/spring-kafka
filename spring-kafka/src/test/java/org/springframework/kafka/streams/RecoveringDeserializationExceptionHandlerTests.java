...
public class RecoveringDeserializationExceptionHandlerTests
	...
	RecoveringDeserializationExceptionHandlerTests() {
		super(RecoveringDeserializationExceptionHandler.KSTREAM_DESERIALIZATION_RECOVERER,
				RecoveringDeserializationExceptionHandler.KSTREAM_DESERIALIZATION_NATIVE_DLQ_DESTINATION_RESOLVER);
	}
