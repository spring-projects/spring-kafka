...
:icons: font
:hide-uri-scheme:
:java-examples: ../../spring-kafka-docs/src/main/java/org/springframework/kafka/jdocs
:kotlin-examples: ../../spring-kafka-docs/src/main/kotlin/org/springframework/kafka/kdocs
