...
The `Environment` contains system properties, the system environment, _and_ properties from the classpath resource `/kafka-broker.properties`.
All of these property sources are consulted when resolving property placeholders.
