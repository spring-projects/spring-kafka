...
With the default implementation, a `ConsumerRecordRecoverer` can be used to handle errors within the batch, without stopping the entire batch - this might be useful when using transactions.
