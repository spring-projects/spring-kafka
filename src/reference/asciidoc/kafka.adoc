...
When using https://docs.spring.io/spring-boot/docs/2.0.4.RELEASE/reference/htmlsingle/#boot-features-kafka-extra-props[Spring Boot], these properties can be provided in the `application.properties` (or yaml) file:
