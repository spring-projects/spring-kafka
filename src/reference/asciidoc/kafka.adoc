...
----
@Bean
public ConsumerFactory<String, String> c\kafkaConsumerFactory(KafkaProperties properties,
...
@Bean
public ProducererFactory<String, String> kafkaProducerFactory(KafkaProperties properties,
