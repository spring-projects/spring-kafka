...
Starting with version 2.0 a couple of support classes have been added to assist with Kerberos configuration.
Simply add these beans, with the desired configuration, to your application context.
