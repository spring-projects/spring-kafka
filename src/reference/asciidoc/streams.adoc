...
To avoid boilerplate code for most cases, especially when you develop micro-services, Spring for Apache Kafka provides the `@EnableKafkaStreams` annotation, which you should placed on a `@Configuration` class.
