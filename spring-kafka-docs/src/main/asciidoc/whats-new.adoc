...
[[x28-react]]
==== `ReactiveListenerAdapter`

A new listener adapter is provided to allow processing reactive workloads on the listener container threads.
See <<reactive-adapter>> for more information.
