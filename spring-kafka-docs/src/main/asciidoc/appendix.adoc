...
If you wish to use a different version of `kafka-clients` or `kafka-streams`, and use the embedded kafka broker for testing, you need to override their version Spring Boot dependency management and add two `test` artifacts for Apache Kafka.
