...
If you wish to use a different version of `kafka-clients` or `kafka-streams`, you need to override their version Spring Boot dependency management and add two `test` artifact for Apache Kafka.
