...
...
ConsumerConfigs.put(DelegatingByTopicSerializer.VALUE_SERIALIZATION_TOPIC_CONFIG,
            "topic[0-4]:" + ByteArrayDeserializer.class.getName()
        + ", topic[5-9]:" + StringDeserializer.class.getName());
----
====

Similar configuration is available for the deserializer.
...
public ProducerFactory<Integer, Object> producerFactory(Map<String, Object> config) {
    return new DefaultKafkaProducerFactory<>(config,
            new DelegatingByTopicSerializer(Map.of(
                    Pattern.compile(".*"), new StringSerializer())),
            new DelegatingByTopicSerializer(Map.of(
...
An additional property `DelegatingByTopicSerializer.CASE_SENSITIVE` (default `true`), when set to `false` makes the topic lookup case insensitive.
