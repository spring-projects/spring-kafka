...
IMPORTANT: With `V2` (default), your brokers must be version 2.5 or later; `kafka-clients` version 3.0, the producer will no lomger fall back to `V1`; if the broker does not support `V2`, an exception is thrown.
