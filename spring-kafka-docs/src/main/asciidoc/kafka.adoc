...
For POJO batch listeners, starting with version 2.8.6, the header is copied into each member of the batch and is also provided as a `List<String>` after conversion.
