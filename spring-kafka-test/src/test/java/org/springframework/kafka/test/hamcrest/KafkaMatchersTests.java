...
public class KafkaMatchersTests {
	...
	public void testKeyMatcher() {
		...
		MatcherAssert.assertThat(record, hasKey("key1"));
		MatcherAssert.assertThat(record, hasValue("value1"));
		MatcherAssert.assertThat(record, hasPartition(0));
		MatcherAssert.assertThat(record, hasTimestamp(1487694048607L));
		MatcherAssert.assertThat(record, hasTimestamp(TimestampType.CREATE_TIME, 1487694048607L));
	}
	...
	public void noMatchOnTimestamp() {
		...
		MatcherAssert.assertThat(record, hasTimestamp(123L));
	}
}
