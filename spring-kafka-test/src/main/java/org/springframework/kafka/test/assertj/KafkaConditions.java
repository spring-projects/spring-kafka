...
public final class KafkaConditions {
	 ...
	 */
	public static <K> Condition<ConsumerRecord<K, ?>> hasKey(K key) {
	 ...
	 */
	public static <V> Condition<ConsumerRecord<?, V>> hasValue(V value) {
	 ...
	 */
	public static Condition<ConsumerRecord<?, ?>> hasPartition(int partition) {
